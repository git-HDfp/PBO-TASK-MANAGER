...
public class CSVHelper {
    ...
    public static List<Task> getTasksByUsername(String username) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(TASKS_FILE))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // Cek format csv: id,title,description,category,priority,status,progress,created_by,created_at
    ...
    // Helper sederhana untuk menangani koma dalam CSV jika diperlukan (implementasi basic)
